...
from pages.links_page import abrir_links, clicar_created, clicar_elements, clicar_home, validar_resposta_created, validar_resposta_home
...
def step_validar_resposta_created(context):
    validar_resposta_created(context.page)